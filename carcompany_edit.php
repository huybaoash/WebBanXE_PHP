...
<?php 
    ...
    if (isset($_POST["btnsubmit"])){
        ...
        $hsx = new CarCompany($hsx["MAHSX"],$TENHSX,$hsx["HINHANH"],$hsx["TRANGTHAI"]);
		...
		<div class="form-horizontal">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-md-10">
            		...
            		<input for="TENHSX"  id = "TENHSX" name ="TENHSX" class = "form-control" Type = "text" placeholder = "Vd: Honda" value="<?php echo $hsx["TENHSX"] ?>" required/>
		        </div>
		        ...
		        <div class="col-md-10">
                    ...
                    <div id="displayImg1">
                        <img src="<?php echo $hsx["HINHANH"] ?>" alt="<?php echo $hsx["TENHSX"] ?>" />
                    </div>
		        </div>
		    </div>
